...
describe('resolver tests', () => {
    test('CLI resolver roundtrips correctly', () => {
        expect(CLI.resolveTestPath(CLI.resolveSnapshotPath(CLI.testPathForConsistencyCheck, '.snap'), '.snap')).toEqual(CLI.testPathForConsistencyCheck);
    });
    ...
    test('IDE resolver roundtrips correctly', () => {
        expect(IDE.resolveTestPath(IDE.resolveSnapshotPath(IDE.testPathForConsistencyCheck, '.snap'), '.snap')).toEqual(IDE.testPathForConsistencyCheck);
    });
